## File Structure
This is the file system in the practice branch.
```
server/
	server.js
src/
...
## server/server.js
This is the contents of the server.js file.
```js
...
## src/App.jsx
This is the contents of the App.jsx file.
```jsx
import './App.css'
...
## ./vite.config.ts
This is the contents of the vite.config.ts file.
```ts
